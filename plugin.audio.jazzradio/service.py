...
def update_linear_metadata(client, player, state):
    ...
    try:
        ...
        xbmc.log(
            f"[plugin.audio.jazzradio] unable to get playing item: {exc!r}",
            xbmc.LOGDEBUG,
        )
        ...
        try:
            ...
            xbmc.log(
                f"[plugin.audio.jazzradio] unable to set playing path: {path_exc!r}",
                xbmc.LOGDEBUG,
            )
    ...
    while not monitor.abortRequested():
        ...
        try:
            ...
            try:
                ...
                xbmc.log(
                    f"[plugin.audio.jazzradio] unable to read playing file: {exc!r}",
                    xbmc.LOGDEBUG,
                )
                continue
